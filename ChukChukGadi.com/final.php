...
<body style="background-size: 100% 100% ">
	  ...
	  <p><button id='down' type='submit'><a href="ticket.pdf">Download Voucher</a></button></p><br><br>
	  <p><button id='down' type='submit'><a href="mailto:someone@example.com?Subject=Your%20ticket">Email voucher</a></button></p>
