	...
	<?php 
		...
		{	
			...
			<OPTION>Election Card </OPTION>
					...
					print"<tr><td>Gender</td><td><INPUT TYPE= RADIO CHECKED NAME='GENDER$in'>Male</td><td><INPUT TYPE= RADIO NAME='GENDER$in'>Female</td></tr>";
					if($in==$not)
					{
						print"<tr><td><p><button id='registerNew' type='submit' onclick='redrict()' formaction='confirm2.php' >Submit</button></p></td></tr>";
					}
				}
