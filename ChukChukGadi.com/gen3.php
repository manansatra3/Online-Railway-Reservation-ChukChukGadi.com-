	...
	<?php
		mysql_connect("localhost", "root") or die(mysql_error()); 
			...
			while($info=mysql_fetch_array($data))
			{
				...
				$bt=$info['Train_name'];
				$ct=$info['Fare'];
				$query="update trains set available='$no'where Train_name='LOKSHAKTI EXPRESS'";
				...
				for ($ps = 1; $ps <= $_SESSION["no"]; $ps++)
				{
					...
					switch ($ps) {
								case 1:
									...
									$query1="insert into details values('$name1',$age1,$pnr1,$at,'$bt',$ct,'$puid1')";
								...
								case 2:
									...
									$query1="insert into details values('$name2',$age2,$pnr2,$at,'$bt',$ct,'$puid2')";
									mysql_query($query1) or die (mysql_error()); 
									$_SESSION["pnr2"]=$pnr2;
									break;
								case 3:
									...
									$query1="insert into details values('$name3',$age3,$pnr3,$at,'$bt',$ct,'$puid3')";
									mysql_query($query1) or die (mysql_error()); 
									$_SESSION["pnr3"]=$pnr3;
									break;
								case 4:
									...
									$query1="insert into details values('$name4',$age4,$pnr4,$at,'$bt',$ct,'$puid4')";
									mysql_query($query1) or die (mysql_error()); 
									$_SESSION["pnr4"]=$pnr4;
									break;
								}
